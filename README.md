...
![GitHub repo size](https://img.shields.io/github/repo-size/lucacattide/dem-boilerplate.svg?style=for-the-badge)
![Github All Releases downloads](https://img.shields.io/github/downloads/lucacattide/dem-boilerplate/total.svg?style=for-the-badge)
[![GitHub contributors](https://img.shields.io/badge/Contributors-1-lightgrey.svg?style=for-the-badge)](https://github.com/lucacattide/dem-boilerplate/graphs/contributors)
![GitHub issues](https://img.shields.io/github/issues/lucacattide/dem-boilerplate.svg?style=for-the-badge)
![GitHub commit activity](https://img.shields.io/github/commit-activity/y/lucacattide/dem-boilerplate.svg?style=for-the-badge)
![GitHub License](https://img.shields.io/github/license/lucacattide/dem-boilerplate.svg?style=for-the-badge)
...
Direct E-Mail (HTML) Marketing boilerplate.
...
- The User is implicitly committed in respect of the Netiquette and of this information - as well as to the current and public social customs - in formulating and sharing its contents, while using the functionalities annexed to the resource and appointed for this purpose, as well as in the compliance with the regulation envisaged as a manifest for the adopted third-party platform use, including by way of non-exhaustive example: education, rejection of the topic of discussion and the personality of the subjects involved, prohibition of promotion and/or sharing of sensitive data in any nature and form - both direct/personal and indirect/to third parties, etc.;

- NAME reserves to himself the right to play the role of Moderator and exercise administrative functions, in the context and in the use by the User of the components for the creation and sharing of its contents - of whatever nature they are, before publication - which will be corrected subsequently to the qualitative evaluation of the same based on the directives contained and foreseen by this information, as well as by the laws in force in the Italian territory in the reference period;

- NAME cannot be held responsible for any content generated by the User - textual and/or iconographic in nature, including by way of non-exhaustive example: links to external and/or third-party resources, multimedia attachments (audio/video), etc. as well as any means to damage, in any form whatsoever, the physical integrity of the systems used - proprietary and/or third-party - as well as that of the subjects involved in the use of existing and/or external resources, not less of the ethical and moral nature of the same;

## 3) Privacy Policy

NAME, pursuant to Art. 13 of the Italian Legislative Decree N. 196/2003 - Privacy Code, in its capacity as data controller, informs you that the data concerning you will be used for execution of the contractual relationship that binds you, as well as for the provision of services directly instrumental to this relationship. The data will be processed by electronic and paper means, according to strictly instrumental methods to the pursuit of the indicated purpose, as well as indicated in the Italian Legislative Decree N. 679/16 - GDPR. The conferment of yours, is necessary for the execution of the contractual relationship with you in place. The information concerning you may be used by employees and consultants of NAME designated in charge of processing or by third parties who hold the qualification of external managers for completion of the operations connected to the aforementioned purpose. Except as indicated above, and for what follows in the paragraph 4), the communication of your data to third parties may only be carried out for the fulfillment of legal obligations or for accounting purposes, as well as to implement the existing contractual relationship. Except for the indications contained in the aforementioned paragraph, your data will not be disclosed or transferred abroad. The data controller is NAME, with headquarters in ADDRESS. The list updated by the managers and the employees is available at NAME and is available for consultation to be made by E-Mail at the address EMAIL or through any channel indicated in the paragraph 4). To have full clarity about the operations we referred to you and to exercise the rights of access, rectification, opposition to the treatment and the other rights referred to in Art. 7 of the Italian Legislative Decree. 196/2003 (Consolidated Law - Privacy Code) we can contact the manager for the management of the requests of the interested parties by letter sent by e-mail to the address EMAIL or as indicated in the paragraph 4).
